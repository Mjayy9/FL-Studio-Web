    ...
    <div class="container formular">
        ...
        <form class="formular" action="ThankYouPage.php" method="POST">
            <div class="form-group justify-content-center">
                <label class="formular_label" style="font-weight: bold">Name and surname</label>
                <input type="text" class="form-control formular_input" name="name" required>
            </div>
            <div class="form-group">
                <label class="formular_label" style="font-weight: bold">E-mail</label>
                <input type="email" id="emailInput" class="form-control formular_input" placeholder="name@mail.com" name="email" required>
            </div>
            <div class="form-group">
                <label class="formular_label" style="font-weight: bold">Request</label>
            ...
            <input id="send" type="submit" class="btn btn-primary" value="Send" name="Send">
        </form>
    </div>
</main>
<?php
